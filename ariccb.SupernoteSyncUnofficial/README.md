# Supernote by Ratta Sync - Unofficial Noteplan Plugin

## Latest Updates

See [CHANGELOG](https://github.com/NotePlan/plugins/blob/main/ariccb.SupernoteSyncUnofficial/CHANGELOG.md) for latest updates/changes to this plugin.

## About This Plugin 

Supernote Sync Unofficial allows you to fetch and sync notes and tasks from the Supernote E-Ink tablet by Ratta into NotePlan.
